...
//       gender: formData.get("gender") as "male" | "female",
//       currentAddress: formData.get("currentAddress") as string,
//       city: formData.get("city") as string, // Added city
//       country: formData.get("country") as string, // Added country
//       admissionNumber: formData.get("admissionNumber") as string,
//       dateOfEntry: formData.get("dateOfEntry") as string,
//       dateOfExit: formData.get("dateOfExit") as string,
//       email: formData.get("email") as string,
//       phone: formData.get("phone") as string,
//       registrationAmount:
//         parseFloat(formData.get("registrationAmount") as string) || 0,
//       transactionReference: formData.get("transactionReference") as string,
//     };
...
//       setSystemRef(result.member.systemReference);
//       setIsSuccess(true);
//       // Don't call onSuccess immediately - let success message show first
//       // onSuccess?.()
//     } catch (err) {
//       setError(
//         err instanceof Error
...
//   const handleCloseSuccess = () => {
//     setIsSuccess(false);
//     onSuccess?.(); // Refresh the members list when closing success message
//   };
...
//         <div className="space-y-2">
//           <Label htmlFor="country">Country *</Label>
//           <Select name="country" defaultValue="Sierra Leone" required>
//             <SelectTrigger>
