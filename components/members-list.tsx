    ...
    return (
      <Card className="w-full">
        <CardHeader>
          ...
          <CardDescription>List of registered NAOSA members</CardDescription>
        </CardHeader>
    ...
    return (
      <Card className="w-full">
        ...
        <CardContent className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <p className="text-muted-foreground">No registered members yet.</p>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>Cusrrent City</TableHead>
