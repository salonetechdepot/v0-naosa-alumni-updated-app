...
import { getApprovedMembers } from '@/lib/store'
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            List of approved NAOSA members
          </CardDescription>
        </CardHeader>
            ...
            <TableBody>
              {currentMembers.map((member, index) => (
                <TableRow key={member.id}>
                  ...
                  <TableCell>{new Date(member.dateOfEntry).getFullYear()}</TableCell>
                  <TableCell>{new Date(member.dateOfExit).getFullYear()}</TableCell>
                  <TableCell>
