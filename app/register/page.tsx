      ...
      <div className="mx-auto max-w-4xl px-4">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mx-auto max-w-2xl text-muted-foreground mb-6">
            Join the Nasir Ahmadiyya Old Students Association (NAOSA). 
            Your registration will be reviewed and approved by our administrators.
          </p>
          ...
          <Dialog open={modalOpen} onOpenChange={setModalOpen}>
            ...
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
              <DialogHeader>
                ...
                <DialogDescription>
                  Fill in your details to register as a NAOSA member. Your registration will be reviewed by an administrator.
                </DialogDescription>
              </DialogHeader>
